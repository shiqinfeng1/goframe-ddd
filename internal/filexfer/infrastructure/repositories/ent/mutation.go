...
const (
	...
	// Node types.
	TypeFileTransferTask = "FileTransferTask"
...
// FileTransferTaskMutation represents an operation that mutates the FileTransferTask nodes in the graph.
type FileTransferTaskMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*FileTransferTask, error)
	predicates    []predicate.FileTransferTask
}

var _ ent.Mutation = (*FileTransferTaskMutation)(nil)

// filetransfertaskOption allows management of the mutation configuration using functional options.
type filetransfertaskOption func(*FileTransferTaskMutation)

// newFileTransferTaskMutation creates new mutation for the FileTransferTask entity.
func newFileTransferTaskMutation(c config, op Op, opts ...filetransfertaskOption) *FileTransferTaskMutation {
	m := &FileTransferTaskMutation{
		config:        c,
		op:            op,
		typ:           TypeFileTransferTask,
...
// withFileTransferTaskID sets the ID field of the mutation.
func withFileTransferTaskID(id int) filetransfertaskOption {
	return func(m *FileTransferTaskMutation) {
		var (
			err   error
			once  sync.Once
			value *FileTransferTask
		)
		m.oldValue = func(ctx context.Context) (*FileTransferTask, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().FileTransferTask.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withFileTransferTask sets the old FileTransferTask of the mutation.
func withFileTransferTask(node *FileTransferTask) filetransfertaskOption {
	return func(m *FileTransferTaskMutation) {
		m.oldValue = func(context.Context) (*FileTransferTask, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m FileTransferTaskMutation) Client() *Client {
...
func (m FileTransferTaskMutation) Tx() (*Tx, error) {
...
func (m *FileTransferTaskMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *FileTransferTaskMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().FileTransferTask.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *FileTransferTaskMutation) SetTaskID(s string) {
	m.task_id = &s
}

// TaskID returns the value of the "task_id" field in the mutation.
func (m *FileTransferTaskMutation) TaskID() (r string, exists bool) {
	v := m.task_id
	if v == nil {
		return
	}
...
// OldTaskID returns the old "task_id" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldTaskID(ctx context.Context) (v string, err error) {
...
func (m *FileTransferTaskMutation) ResetTaskID() {
	m.task_id = nil
}

// SetTaskName sets the "task_name" field.
func (m *FileTransferTaskMutation) SetTaskName(s string) {
	m.task_name = &s
}

// TaskName returns the value of the "task_name" field in the mutation.
func (m *FileTransferTaskMutation) TaskName() (r string, exists bool) {
	v := m.task_name
	if v == nil {
		return
	}
...
// OldTaskName returns the old "task_name" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldTaskName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) ResetTaskName() {
	m.task_name = nil
}

// SetNodeID sets the "node_id" field.
func (m *FileTransferTaskMutation) SetNodeID(s string) {
	m.node_id = &s
}

// NodeID returns the value of the "node_id" field in the mutation.
func (m *FileTransferTaskMutation) NodeID() (r string, exists bool) {
	v := m.node_id
	if v == nil {
		return
	}
...
// OldNodeID returns the old "node_id" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldNodeID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) ResetNodeID() {
	m.node_id = nil
}

// SetStatus sets the "status" field.
func (m *FileTransferTaskMutation) SetStatus(i int) {
	m.status = &i
	m.addstatus = nil
}

// Status returns the value of the "status" field in the mutation.
func (m *FileTransferTaskMutation) Status() (r int, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldStatus(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) AddStatus(i int) {
	if m.addstatus != nil {
		*m.addstatus += i
	} else {
		m.addstatus = &i
...
func (m *FileTransferTaskMutation) AddedStatus() (r int, exists bool) {
	v := m.addstatus
	if v == nil {
		return
	}
...
func (m *FileTransferTaskMutation) ResetStatus() {
	m.status = nil
	m.addstatus = nil
}

// SetElapsed sets the "elapsed" field.
func (m *FileTransferTaskMutation) SetElapsed(s string) {
	m.elapsed = &s
}

// Elapsed returns the value of the "elapsed" field in the mutation.
func (m *FileTransferTaskMutation) Elapsed() (r string, exists bool) {
	v := m.elapsed
	if v == nil {
		return
	}
...
// OldElapsed returns the old "elapsed" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldElapsed(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) ResetElapsed() {
	m.elapsed = nil
}

// SetSpeed sets the "speed" field.
func (m *FileTransferTaskMutation) SetSpeed(s string) {
	m.speed = &s
}

// Speed returns the value of the "speed" field in the mutation.
func (m *FileTransferTaskMutation) Speed() (r string, exists bool) {
	v := m.speed
	if v == nil {
		return
	}
...
// OldSpeed returns the old "speed" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldSpeed(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) ResetSpeed() {
	m.speed = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *FileTransferTaskMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *FileTransferTaskMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *FileTransferTaskMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *FileTransferTaskMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the FileTransferTask entity.
// If the FileTransferTask object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *FileTransferTaskMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *FileTransferTaskMutation) ResetCreatedAt() {
	m.created_at = nil
}

// Where appends a list predicates to the FileTransferTaskMutation builder.
func (m *FileTransferTaskMutation) Where(ps ...predicate.FileTransferTask) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the FileTransferTaskMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *FileTransferTaskMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.FileTransferTask, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *FileTransferTaskMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *FileTransferTaskMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (FileTransferTask).
func (m *FileTransferTaskMutation) Type() string {
	return m.typ
}
...
// AddedFields().
func (m *FileTransferTaskMutation) Fields() []string {
	fields := make([]string, 0, 8)
	if m.task_id != nil {
		fields = append(fields, filetransfertask.FieldTaskID)
	}
	if m.task_name != nil {
		fields = append(fields, filetransfertask.FieldTaskName)
	}
	if m.node_id != nil {
		fields = append(fields, filetransfertask.FieldNodeID)
	}
	if m.status != nil {
		fields = append(fields, filetransfertask.FieldStatus)
	}
	if m.elapsed != nil {
		fields = append(fields, filetransfertask.FieldElapsed)
	}
	if m.speed != nil {
		fields = append(fields, filetransfertask.FieldSpeed)
	}
	if m.updated_at != nil {
		fields = append(fields, filetransfertask.FieldUpdatedAt)
	}
	if m.created_at != nil {
		fields = append(fields, filetransfertask.FieldCreatedAt)
	}
	return fields
}
...
// schema.
func (m *FileTransferTaskMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// database failed.
func (m *FileTransferTaskMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case filetransfertask.FieldTaskID:
	...
	return nil, fmt.Errorf("unknown FileTransferTask field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FileTransferTaskMutation) SetField(name string, value ent.Value) error {
	switch name {
	case filetransfertask.FieldTaskID:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown FileTransferTask field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *FileTransferTaskMutation) AddedFields() []string {
	var fields []string
	if m.addstatus != nil {
		fields = append(fields, filetransfertask.FieldStatus)
	}
...
func (m *FileTransferTaskMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case filetransfertask.FieldStatus:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FileTransferTaskMutation) AddField(name string, value ent.Value) error {
	switch name {
	case filetransfertask.FieldStatus:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown FileTransferTask numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *FileTransferTaskMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *FileTransferTaskMutation) FieldCleared(name string) bool {
...
func (m *FileTransferTaskMutation) ClearField(name string) error {
	return fmt.Errorf("unknown FileTransferTask nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *FileTransferTaskMutation) ResetField(name string) error {
	switch name {
	case filetransfertask.FieldTaskID:
		m.ResetTaskID()
		return nil
...
func (m *FileTransferTaskMutation) AddedEdges() []string {
...
func (m *FileTransferTaskMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *FileTransferTaskMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *FileTransferTaskMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *FileTransferTaskMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *FileTransferTaskMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *FileTransferTaskMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown FileTransferTask unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *FileTransferTaskMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown FileTransferTask edge %s", name)
}
