...
var file_filemgr_v1_send_proto_rawDesc = []byte{
...
var (
	...
	file_filemgr_v1_send_proto_rawDescData = file_filemgr_v1_send_proto_rawDesc
)

func file_filemgr_v1_send_proto_rawDescGZIP() []byte {
	file_filemgr_v1_send_proto_rawDescOnce.Do(func() {
		file_filemgr_v1_send_proto_rawDescData = protoimpl.X.CompressGZIP(file_filemgr_v1_send_proto_rawDescData)
	})
	return file_filemgr_v1_send_proto_rawDescData
}

var file_filemgr_v1_send_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_filemgr_v1_send_proto_goTypes = []interface{}{
...
func file_filemgr_v1_send_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_filemgr_v1_send_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_filemgr_v1_send_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_filemgr_v1_send_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_filemgr_v1_send_proto_rawDesc = nil
