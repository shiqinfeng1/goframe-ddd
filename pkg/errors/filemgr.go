...
var (
	...
	ErrNatsConnectFail = func(f string) error { return gerror.NewCode(gcode.New(200001, "连接nats失败:"+f, nil)) }
	ErrNatsStreamFail  = func(f string) error { return gerror.NewCode(gcode.New(200002, "查询stream失败:"+f, nil)) }
)
