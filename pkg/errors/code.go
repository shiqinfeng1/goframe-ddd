...
func codeFunc(c gcode.Code, token string) func(string) error {
	return func(l string) error {
		...
		return gerror.NewCode(c, locale.Lang[l].T(ctx, token))
	}
}
...
const (
	...
	//	--00：发送模块
	//	--01: 文件读写模块
	CodeNotAbsFilePath = 100001 + iota //100001
	CodeEmptyDir                       //100002
	CodeInvalidFiles                   //100003
	CodeInvalidNodeId                  //100004
	CodeOver4GSize     = 100101 + iota //100101
	// 11：消息队列
	//	--00：nats管理
	CodeNatsConnectFail       = 110001 + iota //110001
	...
	//	--00: 容器信息查询
	//	--01：版本升级
	CodeQueryImageFail   = 120001 + iota //120001
	CodeUpgradeAppFail   = 120101 + iota //120101
	CodeUpgradeImageFail                 //120102

	// 13: 认证
	//	--00: 用户管理
	//	--01: token管理
	CodeSendVCodeFail        = 130001 + iota //130001
	CodeResetPwdFail                         //130002
	CodeRegisterUserFail                     //130003
	CodeLoginFail                            //130004
	CodeLogoutFail                           //130005
	CodeAuthRefreshTokenFail = 130101 + iota //130101
)
