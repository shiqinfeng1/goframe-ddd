...
//
//	mockgen -destination=mock_client.go -package=nats -source=./interfaces.go Client,Subscription,ConnIntf,ConnectionManagerIntf,SubscriptionManagerIntf,StreamManagerIntf
//
...
func (m *MockConnIntf) NATSConn() *nats_go.Conn {
	m.ctrl.T.Helper()
...
func (m *MockConnIntf) Status() nats_go.Status {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Status")
	ret0, _ := ret[0].(nats_go.Status)
	return ret0
}
...
func (m *MockConnector) Connect(arg0 string, arg1 ...nats_go.Option) (ConnIntf, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0}
	for _, a := range arg1 {
